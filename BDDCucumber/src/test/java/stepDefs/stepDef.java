...
static WebDriver driver;
	...
	public static void user_is_on_launch_page1() {
	...
	public void user_login() {
	    ...
	    driver.findElement(By.xpath("//input[@id='loginusername']")).sendKeys("nadhan");
	    driver.findElement(By.xpath("//input[@id='loginpassword']")).sendKeys("secret");
	    driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
	...
	public void should_display_home_page() {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		boolean isDisp  = driver.findElement(By.xpath("//a[contains(text(),'Welcome nadhan')]")).isDisplayed();
		Assert.assertTrue(isDisp);
	}
	
	@Given("User is on Launch Page2")
	public static void user_is_on_launch_page2() {
		WebDriverManager.chromedriver().setup();
		ChromeOptions options = new ChromeOptions();
		options.addArguments("--remote-allow-origins=*");
		driver = new ChromeDriver(options);
	...
	public static void user_is_on_launch_page3() {
		WebDriverManager.chromedriver().setup();
		ChromeOptions options = new ChromeOptions();
		options.addArguments("--remote-allow-origins=*");
		driver = new ChromeDriver(options);
	...
	public static void user_is_on_launch_page4() {
		WebDriverManager.chromedriver().setup();
		ChromeOptions options = new ChromeOptions();
		options.addArguments("--remote-allow-origins=*");
		driver = new ChromeDriver(options);
